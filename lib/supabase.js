...
export const demoData = {
  ...
  events: [
    { id: '1', title: 'Annual Day Celebration', description: 'Cultural programs, dance, music and awards ceremony.', event_date: '2026-12-15', event_time: '10:00', venue: 'School Auditorium' },
    { id: '2', title: 'Sports Day', description: 'Annual sports meet with track events, races and team games.', event_date: '2026-11-20', event_time: '08:00', venue: 'School Ground' },
    { id: '3', title: 'Parent-Teacher Meeting', description: 'Quarterly progress review meeting.', event_date: '2026-09-10', event_time: '09:00', venue: 'School Hall' },
    { id: '4', title: 'Summer Vacation', description: 'School closed for summer break.', event_date: '2027-05-01', is_holiday: true },
    { id: '5', title: 'Republic Day Celebration', description: 'Flag hoisting and cultural program.', event_date: '2027-01-26', event_time: '08:30', venue: 'School Ground' },
    { id: '6', title: 'Diwali Break', description: 'School closed for Diwali.', event_date: '2026-10-20', is_holiday: true },
    { id: '7', title: 'Independence Day Celebration', description: 'Flag hoisting, patriotic songs and cultural program.', event_date: '2026-08-15', event_time: '08:30', venue: 'School Ground' },
    { id: '8', title: 'Teachers Day Celebration', description: 'Students felicitate teachers with cards, songs and performances.', event_date: '2026-09-05', event_time: '10:00', venue: 'School Hall' },
    { id: '9', title: 'Childrens Day Celebration', description: 'Fun games, cultural performances and treats for all students.', event_date: '2026-11-14', event_time: '09:00', venue: 'School Ground' },
    { id: '10', title: 'Chhath Puja Break', description: 'School closed for Chhath Puja.', event_date: '2026-11-15', is_holiday: true },
  ],
  resources: [
